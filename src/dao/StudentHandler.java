...
public class StudentHandler {
    ...
    public int deleteStudent(int samID, int mtrId) {
        String cmdTemplate ="Delete student from student JOIN person on student.samID=person.samID where student.samID = %s";
