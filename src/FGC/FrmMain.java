<<<<<<< Updated upstream:src/FGC/FrmMain.java
/*
...
/**
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if(SelectedRow!=-1){
            //Performs the delete
            int mtrId = (int)tblStudents.getValueAt(SelectedRow,0);
            ...
            studentHandler.deleteStudent(samID,mtrId);
            refreshTableStudents();
        }else{
...
>>>>>>> Stashed changes:src/fgc/FrmMain.java
